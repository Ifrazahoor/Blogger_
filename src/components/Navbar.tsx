...
const Navbar = () => {
  ...
  return (
     <div className="w-full bg-white/70 h-20 shadow-md sticky top-0
     backdrop:blur-2xl transition-colors z-50">
            ...
            <div className="hidden md:inline-flex items-center gap-7
              text-gray-900 hover:text-black duration-200">
                {navigation.map((item)=>(
                    ...
                    {item?.title}
                    <span className="w-full h-[1px] bg-blue-700 absolute 
                    inline-block left-0 bottom-0 translate-x-[100%] 
